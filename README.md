## 1. Research Results Summary of the SSD research paper

-  You can use the [editor on GitHub](https://github.com/vanshajkhattar/AML_SSD_final_project/edit/master/README.md) to maintain and preview the content for your website in Markdown files.
